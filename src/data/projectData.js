...
const projectData = [
  ...
  {
    id: 6,
    title: "A modern real estate platform",
    image: s1,
    images: [
      {
        src: s1,
    ...
    techStack: ["HTML5", "CSS3 (Tailwind CSS)", "JavaScript (Alpine.js)", "Reactjs"],
    features: [
      "Property listings with location & price details",
